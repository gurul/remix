        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/10 border border-white/10">
          ...
          <div className="bg-[#0c0a09] p-16">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-4 text-[10px] font-mono font-normal uppercase tracking-[0.3em] text-accent border-b border-accent pb-1 hover:border-accent/80 transition-colors group"
            >
